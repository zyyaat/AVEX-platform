// Package financial is the composition root for the financial module.
package financial
...
import (
	...
	"avex-backend/internal/modules/financial/repository/postgres"
	"avex-backend/internal/modules/financial/service"
	httptransport "avex-backend/internal/modules/financial/transport/http"
	idp "avex-backend/internal/modules/identity/port"
	"avex-backend/internal/platform/config"
)

// Module is the wired financial module.
type Module struct {
...
// New wires all financial dependencies and returns a ready-to-use Module.
...
// RegisterRoutes wires the financial HTTP routes into the given mux.
