// Package settings is the composition root for the settings module.
package settings
...
import (
	...
	"avex-backend/internal/modules/settings/repository/postgres"
	"avex-backend/internal/modules/settings/service"
	httptransport "avex-backend/internal/modules/settings/transport/http"
...
func (m *Module) NewInbox() inbox.Inbox {
	return &inboxAdapter{inner: inbox.NewPostgresInbox(m.pool, inbox.Config{Table: "settings.inbox"})}
}
