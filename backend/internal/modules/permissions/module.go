// Package permissions is the composition root for the permissions module.
package permissions
...
import (
	...
	"avex-backend/internal/modules/permissions/repository/postgres"
	"avex-backend/internal/modules/permissions/service"
	httptransport "avex-backend/internal/modules/permissions/transport/http"
...
func (m *Module) NewInbox() inbox.Inbox {
	return &inboxAdapter{inner: inbox.NewPostgresInbox(m.pool, inbox.Config{Table: "permissions.inbox"})}
}
